...
class GoogleOAuthService:
    ...
    async def get_drive_files(self, credentials: Credentials, query: str = '', max_results: int = 10) -> Dict[str, Any]:
        ...
        return await _get_drive_files(credentials, query, max_results, self.refresh_credentials_if_needed)
    ...
    async def search_drive_files(self, credentials: Credentials, search_term: str = '', file_type: str = '',
        ...
        return await _search_drive_files(credentials, search_term, file_type, year, max_results, self.refresh_credentials_if_needed)
    ...
    async def search_drive_folders(self, credentials: Credentials, folder_name: str, max_results: int = 10) -> Dict[str, Any]:
        ...
        return await _search_drive_folders(credentials, folder_name, max_results, self.refresh_credentials_if_needed)
    ...
    async def create_folder_structure(self, credentials: Credentials, folder_path: str, root_folder: str = "TURFMAPP") -> str:
        ...
        return await _create_folder_structure(credentials, folder_path, root_folder, self.refresh_credentials_if_needed)
    ...
    async def upload_file_to_drive(self, credentials: Credentials, file_content: bytes, filename: str, folder_path: str = None) -> Dict[str, Any]:
        ...
        return await _upload_file_to_drive(credentials, file_content, filename, folder_path,
                                          self.refresh_credentials_if_needed, self.create_folder_structure)

    async def delete_file_from_drive(self, credentials: Credentials, file_id: str) -> Dict[str, Any]:
        """Delete file from user's Drive."""
        return await _delete_file_from_drive(credentials, file_id, self.refresh_credentials_if_needed)
    ...
    async def list_files_in_folder(self, credentials: Credentials, folder_path: str) -> Dict[str, Any]:
        ...
        return await _list_files_in_folder(credentials, folder_path, self.refresh_credentials_if_needed, self.create_folder_structure)
    ...
    async def get_shared_drives(self, credentials: Credentials, max_results: int = 10) -> Dict[str, Any]:
        ...
        return await _get_shared_drives(credentials, max_results, self.refresh_credentials_if_needed)

    # Calendar API methods
    async def get_calendar_events(self, credentials: Credentials, calendar_id: str = 'primary',
                                 max_results: int = 10, upcoming_only: bool = True) -> Dict[str, Any]:
        """Get Google Calendar events for the authenticated user."""
        return await _get_calendar_events(credentials, calendar_id, max_results, upcoming_only)
